...
const CAPTURE_GROUPS: GroupConfig[] = [
  {
    ...
    levels: [
      // 1-3: 单目标一步吃
      { level: 1, fen: '4k3/8/8/p7/8/8/8/R6K w - - 0 1', targets: ['a5'], minMoves: 1 },
      { level: 2, fen: '4k3/8/8/8/8/p7/8/R6K w - - 0 1', targets: ['a3'], minMoves: 1 },
      { level: 3, fen: '4k3/p7/8/8/8/8/8/R6K w - - 0 1', targets: ['a7'], minMoves: 1 },
      // 4-10: 多目标连吃
      { level: 4, fen: '4k3/8/8/p7/8/p7/8/R6K w - - 0 1', targets: ['a3', 'a5'], minMoves: 2 },
      { level: 5, fen: '4k3/p7/8/8/8/p7/8/R6K w - - 0 1', targets: ['a3', 'a7'], minMoves: 2 },
      { level: 6, fen: '4k3/p7/8/p7/8/p7/8/R6K w - - 0 1', targets: ['a3', 'a5', 'a7'], minMoves: 3 },
      { level: 7, fen: '4k3/8/8/8/8/8/p6p/R6K w - - 0 1', targets: ['a2', 'h2'], minMoves: 2 },
      { level: 8, fen: '4k3/8/8/p7/8/8/p7/R6K w - - 0 1', targets: ['a2', 'a5'], minMoves: 2 },
      { level: 9, fen: '4k3/p7/8/p7/8/p7/p7/R6K w - - 0 1', targets: ['a2', 'a3', 'a5', 'a7'], minMoves: 4 },
      { level: 10, fen: '4k3/p7/p7/p7/8/p7/p7/R6K w - - 0 1', targets: ['a2', 'a3', 'a5', 'a6', 'a7'], minMoves: 5 },
    ],
  },
  {
    key: 'bishop',
    ...
    levels: [
      ...
      { level: 2, fen: '4k3/8/8/8/4p3/8/8/1B5K w - - 0 1', targets: ['e4'], minMoves: 1 },
      { level: 3, fen: '4k3/8/5p2/8/8/8/8/B6K w - - 0 1', targets: ['f6'], minMoves: 1 },
      { level: 4, fen: '4k3/8/8/8/3p4/2p5/8/B6K w - - 0 1', targets: ['c3', 'd4'], minMoves: 2 },
      { level: 5, fen: '4k3/8/5p2/4p3/8/8/8/B6K w - - 0 1', targets: ['e5', 'f6'], minMoves: 2 },
      { level: 6, fen: '4k3/8/5p2/4p3/3p4/8/8/B6K w - - 0 1', targets: ['d4', 'e5', 'f6'], minMoves: 3 },
      { level: 7, fen: '4k3/8/8/4p3/3p4/2p5/8/B6K w - - 0 1', targets: ['c3', 'd4', 'e5'], minMoves: 3 },
      { level: 8, fen: '4k3/8/5p2/4p3/3p4/2p5/1p6/B6K w - - 0 1', targets: ['b2', 'c3', 'd4', 'e5', 'f6'], minMoves: 5 },
      { level: 9, fen: '4k3/8/5p2/4p3/3p4/2p5/8/B6K w - - 0 1', targets: ['c3', 'd4', 'e5', 'f6'], minMoves: 4 },
      { level: 10, fen: '4k3/6p1/5p2/4p3/3p4/2p5/1p6/B6K w - - 0 1', targets: ['b2', 'c3', 'd4', 'e5', 'f6', 'g7'], minMoves: 6 },
    ],
  },
  {
    key: 'queen',
    ...
    levels: [
      ...
      { level: 2, fen: '4k3/8/8/8/3p4/8/8/Q6K w - - 0 1', targets: ['d4'], minMoves: 1 },
      { level: 3, fen: '4k3/8/8/8/8/2p5/8/Q6K w - - 0 1', targets: ['c3'], minMoves: 1 },
      { level: 4, fen: '4k3/8/8/p7/8/2p5/8/Q6K w - - 0 1', targets: ['a5', 'c3'], minMoves: 2 },
      { level: 5, fen: '4k3/8/8/p7/p7/8/8/Q6K w - - 0 1', targets: ['a4', 'a5'], minMoves: 2 },
      { level: 6, fen: '4k3/8/8/p7/3p4/2p5/8/Q6K w - - 0 1', targets: ['c3', 'd4', 'a5'], minMoves: 3 },
      { level: 7, fen: '4k3/p7/8/8/3p4/8/1p6/Q6K w - - 0 1', targets: ['b2', 'd4', 'a7'], minMoves: 3 },
      { level: 8, fen: '4k3/p7/8/p7/3p4/2p5/8/Q6K w - - 0 1', targets: ['c3', 'd4', 'a5', 'a7'], minMoves: 4 },
      { level: 9, fen: '4k3/p7/8/p7/3p4/2p5/1p6/Q6K w - - 0 1', targets: ['b2', 'c3', 'd4', 'a5', 'a7'], minMoves: 5 },
      { level: 10, fen: '4k3/p7/5p2/p7/3p4/2p5/1p6/Q6K w - - 0 1', targets: ['b2', 'c3', 'd4', 'a5', 'f6', 'a7'], minMoves: 6 },
    ],
  },
  {
    key: 'knight',
    ...
    levels: [
      ...
      { level: 2, fen: '4k3/8/8/8/8/1p6/8/2N4K w - - 0 1', targets: ['b3'], minMoves: 1 },
      { level: 3, fen: '4k3/8/8/8/8/2p5/8/1N5K w - - 0 1', targets: ['c3'], minMoves: 1 },
      // 马的多目标：使用验证过的L形连吃链
      // c1→a2→b4, c1→b3→a5, c1→a2→b4→d3, etc.
      { level: 4, fen: '4k3/8/8/8/1p6/8/p7/2N4K w - - 0 1', targets: ['a2', 'b4'], minMoves: 2 },
      { level: 5, fen: '4k3/8/8/p7/8/1p6/8/2N4K w - - 0 1', targets: ['b3', 'a5'], minMoves: 2 },
      { level: 6, fen: '4k3/8/8/8/1p6/3p4/p7/2N4K w - - 0 1', targets: ['a2', 'b4', 'd3'], minMoves: 3 },
      { level: 7, fen: '4k3/8/p7/8/1p6/8/p7/2N4K w - - 0 1', targets: ['a2', 'b4', 'a6'], minMoves: 3 },
      { level: 8, fen: '4k3/8/p7/2p5/1p6/8/p7/2N4K w - - 0 1', targets: ['a2', 'b4', 'a6', 'c5'], minMoves: 4 },
      { level: 9, fen: '4k3/8/p7/2p5/pp6/8/p7/2N4K w - - 0 1', targets: ['a2', 'b4', 'a6', 'c5', 'a4'], minMoves: 5 },
      { level: 10, fen: '4k3/8/p7/2p5/pp6/8/pp6/2N4K w - - 0 1', targets: ['a2', 'b4', 'a6', 'c5', 'a4', 'b2'], minMoves: 6 },
    ],
  },
]
