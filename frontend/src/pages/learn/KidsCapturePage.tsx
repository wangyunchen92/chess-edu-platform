...
const CAPTURE_GROUPS: GroupConfig[] = [
  {
    ...
    levels: [
      // 1-3: 单目标一步吃
      { level: 1, fen: '4k3/8/8/p7/8/8/8/R3K3 w - - 0 1', targets: ['a5'], minMoves: 1 },
      { level: 2, fen: '4k3/8/8/8/8/p7/8/R3K3 w - - 0 1', targets: ['a3'], minMoves: 1 },
      { level: 3, fen: '4k3/p7/8/8/8/8/8/R3K3 w - - 0 1', targets: ['a7'], minMoves: 1 },
      // 4-10: 多目标连吃
      { level: 4, fen: '4k3/8/8/p7/8/p7/8/R3K3 w - - 0 1', targets: ['a3', 'a5'], minMoves: 2 },
      { level: 5, fen: '4k3/p7/8/8/8/p7/8/R3K3 w - - 0 1', targets: ['a3', 'a7'], minMoves: 2 },
      { level: 6, fen: '4k3/p7/8/p7/8/p7/8/R3K3 w - - 0 1', targets: ['a3', 'a5', 'a7'], minMoves: 3 },
      { level: 7, fen: '4k3/8/8/8/8/8/p6p/R3K3 w - - 0 1', targets: ['a2', 'h2'], minMoves: 2 },
      { level: 8, fen: '4k3/8/8/p7/8/8/p7/R3K3 w - - 0 1', targets: ['a2', 'a5'], minMoves: 2 },
      { level: 9, fen: '4k3/p7/8/p7/8/p7/p7/R3K3 w - - 0 1', targets: ['a2', 'a3', 'a5', 'a7'], minMoves: 4 },
      { level: 10, fen: '4k3/p7/p7/p7/8/p7/p7/R3K3 w - - 0 1', targets: ['a2', 'a3', 'a5', 'a6', 'a7'], minMoves: 5 },
    ],
  },
  {
    key: 'bishop',
  ...
  },
  {
    ...
    levels: [
      ...
      { level: 9, fen: '4k3/p7/8/p7/3p4/2p5/1p6/Q3K3 w - - 0 1', targets: ['b2', 'c3', 'd4', 'a5', 'a7'], minMoves: 5 },
      { level: 10, fen: '4k3/p7/5p2/p7/3p4/2p5/1p6/Q3K3 w - - 0 1', targets: ['b2', 'c3', 'd4', 'a5', 'f6', 'a7'], minMoves: 6 },
    ],
  },
  {
    key: 'knight',
