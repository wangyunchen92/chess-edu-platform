    ...
    items: [
      {
        ...
        icon: (
          <svg width="20" height="20" viewBox="0 0 20 20" fill="none">
            <path d="M6 9l4-6 4 6M4 9h12M5 9l1 8h8l1-8" stroke="currentColor" strokeWidth="1.8" strokeLinecap="round" strokeLinejoin="round" />
          </svg>
        ),
      },
      {
        ...
        {groups.map((group, gi) => {
          ...
          return (
            <React.Fragment key={group.key}>
              {gi > 0 && <div className="my-2 mx-1 border-t border-white/10" />}
